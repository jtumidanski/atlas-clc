...
func (h *CharacterSelectHandler) IsValid(l *log.Logger, s *sessions.Session) bool {
	return processors.IsLoggedIn(l, s.AccountId())
}

func (h *CharacterSelectHandler) Handle(l *log.Logger, s *sessions.Session, r *inputs.Reader) {
